...
//           "Transcribe the following audio assume the audio is in english and transcript it in english:",
...
//         "in just 1 to 5 lines to improve it in JSON format with rating field and feedback field";
...
//         mockIdRef: interviewData?.mockId || "default_mock_id",
  ...
  const updateUserAnswer = async () => {
    try {
      ...
      const feedbackPrompt =
        ...
        ", User Answer: " +
        userAnswer +
        ". Based on the question and user answer, please give a rating (1-5) and feedback (1-5 lines) in JSON format with `rating` and `feedback` fields.";
      ...
      if (!interviewData?.mockId) {
        throw new Error("mockId is missing in interviewData");
      }
